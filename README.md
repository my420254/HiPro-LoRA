...
```text
HiPro-loRA/
├── table2_strict/                  # Main strict held-out results
├── table3_strict/                  # Fine-grained ablation results
├── sensitivity_gate_strict/        # Sensitivity and gate-dynamics runs
...
```bash
cd /home/zmy/a-start/HiPro-LoRA/HiPro-LoRA/mainCode
source /home/zmy/miniconda3/etc/profile.d/conda.sh
conda activate /home/zmy/envs/hipro-lora
...
| SST-5 | `SetFit/sst5` | The script uses the official `train`, `validation`, and `test` splits. Validation and test subsets are class-balanced with seed `42`. |
...
python -u HiPro-loRA/run_scripts/run_gate_table2_aligned.py
