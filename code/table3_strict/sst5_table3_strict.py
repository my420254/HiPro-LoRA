...
CONFIGS = {
    ...
    1150: {
        ...
        "eval_steps": 10, "memory_size": 200, "temperature": 0.15, "loss_weight": 0.005,
...
ARTIFACT_DIR = os.path.join(SCRIPT_DIR, "artifacts", "sst5")
os.makedirs(RESULTS_DIR, exist_ok=True)
os.makedirs(ARTIFACT_DIR, exist_ok=True)
MAIN_RESULTS_FILE = os.path.join(SCRIPT_DIR, "results", "sst5_table3_strict_results.csv")
SENSITIVITY_FILE = os.path.join(SCRIPT_DIR, "results", "sst5_table3_strict_sensitivity_unused.csv")
