...
ARTIFACT_DIR = os.path.join(SCRIPT_DIR, "artifacts", "sst5", "sst5_main_table2_strict")
os.makedirs(RESULTS_DIR, exist_ok=True)
os.makedirs(ARTIFACT_DIR, exist_ok=True)
MAIN_RESULTS_FILE = os.path.join(SCRIPT_DIR, "results", "sst5_main_table2_strict_results.csv")
SENSITIVITY_FILE = os.path.join(SCRIPT_DIR, "results", "sst5_main_table2_strict_sensitivity_unused.csv")
