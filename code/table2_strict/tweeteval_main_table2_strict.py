...
ARTIFACT_DIR = os.path.join(SCRIPT_DIR, "artifacts", "tweeteval", "tweeteval_main_table2_strict")
os.makedirs(RESULTS_DIR, exist_ok=True)
os.makedirs(ARTIFACT_DIR, exist_ok=True)
MAIN_RESULTS_FILE = os.path.join(SCRIPT_DIR, "results", "tweeteval_main_table2_strict_results.csv")
SENSITIVITY_FILE = os.path.join(SCRIPT_DIR, "results", "tweeteval_main_table2_strict_sensitivity_unused.csv")
...
print(f"\n{'='*80}\nPART A: STRICT HELD-OUT MAIN EXPERIMENTS\n{'='*80}")
