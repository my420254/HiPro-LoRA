...
CONFIGS = {
    1000: {
        ...
        "eval_steps": 15, "loss_weight": 0.001,     
...
ARTIFACT_DIR = os.path.join(SCRIPT_DIR, "artifacts", "tweeteval", "tweeteval_lora_adv_table2_strict")
os.makedirs(RESULTS_DIR, exist_ok=True)
os.makedirs(ARTIFACT_DIR, exist_ok=True)
MAIN_RESULTS_FILE = os.path.join(SCRIPT_DIR, "results", "tweeteval_lora_adv_table2_strict_results.csv")
...
print(f"\n{'='*80}\nSTRICT HELD-OUT EXPERIMENT START: TweetEval LoRA-Adv\n{'='*80}")
