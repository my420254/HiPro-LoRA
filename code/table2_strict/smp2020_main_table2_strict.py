...
ARTIFACT_DIR = os.path.join(SCRIPT_DIR, "artifacts", "smp2020", "smp2020_main_table2_strict")
os.makedirs(RESULTS_DIR, exist_ok=True)
os.makedirs(ARTIFACT_DIR, exist_ok=True)
MAIN_RESULTS_FILE = os.path.join(SCRIPT_DIR, "results", "smp2020_main_table2_strict_results.csv")
SENSITIVITY_FILE = os.path.join(SCRIPT_DIR, "results", "smp2020_main_table2_strict_sensitivity_unused.csv")
